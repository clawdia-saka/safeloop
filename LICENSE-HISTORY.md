...
The MIT grant is an additional, permissive license that recipients may rely on notwithstanding the absence of a license notice in an older snapshot. It permits use, copying, modification, merging, publication, distribution, sublicensing, sale, commercial use, and production use, subject only to the conditions in the MIT License.

Existing permissions are not withdrawn. This grant does not convey trademark rights or imply endorsement.
