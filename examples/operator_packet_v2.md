...
- local anchor status: not_present
- evidence packet status: present
- issues / warnings:
  - none
...
| fake-ticket | manual_review_item | external-evidence.log | queued | false | external-evidence.log |
| fake-ticket | compensation_item | external-evidence.log | compensation_review_required | false | external-evidence.log |
